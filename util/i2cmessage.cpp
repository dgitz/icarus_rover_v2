...
/***Created on:2019-09-04 07:18:36.582977***/
/***Target: Raspberry Pi ***/
...
int I2CMessageHandler::decode_Get_ANA_Port1I2C(unsigned char* inbuffer,int * length,uint16_t* Pin1_Value,uint16_t* Pin2_Value,uint16_t* Pin3_Value,uint16_t* Pin4_Value,uint16_t* Pin5_Value,uint16_t* Pin6_Value,uint16_t* Pin6_Value)
{
	...
	*Pin6_Value = v_Pin6_Value + inbuffer[11];
	int v_Pin6_Value = inbuffer[12]<<8;
	*Pin6_Value = v_Pin6_Value + inbuffer[13];
	return 1;
}
