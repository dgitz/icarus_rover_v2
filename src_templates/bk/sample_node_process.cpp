...
/*! \brief Constructor
 */
SampleNodeProcess::SampleNodeProcess(std::string _base_node_name,
 ...
 */
icarus_rover_v2::diagnostic SampleNodeProcess::init(
		icarus_rover_v2::diagnostic indiag, std::string hostname) {
	myhostname = hostname;
	diagnostic = indiag;
 ...
 */
icarus_rover_v2::diagnostic SampleNodeProcess::new_devicemsg(
 ...
 */
std::vector<icarus_rover_v2::diagnostic> SampleNodeProcess::new_commandmsg(
