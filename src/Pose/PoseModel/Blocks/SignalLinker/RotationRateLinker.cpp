...
RotationRateLinker::RotationRateLinker() {
...
eros::diagnostic RotationRateLinker::new_input(std::vector<SplitSignal> inputs)
{
...
eros::diagnostic RotationRateLinker::update_input(std::vector<SplitSignal> inputs)
{
    eros::diagnostic diag = diagnostic;
    for(std::size_t i = 0; i < inputs.size(); ++i)
    {
