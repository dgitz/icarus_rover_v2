...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Pose_AutoCode
...
PRODUCT_NAME              = Pose_AutoCode
MAKEFILE                  = Pose_AutoCode.mk
MATLAB_ROOT               = /usr/local/MATLAB/R2019b
MATLAB_BIN                = /usr/local/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/robot/catkin_ws/src/icarus_rover_v2/src/Pose
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Pose_AutoCode
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Pose_AutoCode_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=Pose_AutoCode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/Pose_AutoCode_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pose_AutoCode_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
