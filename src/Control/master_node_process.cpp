...
/*! \brief Constructor
 */
MasterNodeProcess::MasterNodeProcess(std::string _base_node_name,std::string _node_name)
{
...
/*! \brief Run Unit Test
 */
std::vector<icarus_rover_v2::diagnostic> MasterNodeProcess::run_unittest()
{
	std::vector<icarus_rover_v2::diagnostic> diaglist;
