// Derived class
#include "CommandLauncherNodeProcess.cpp"
...
//ROS Messages
//Project
/*! \class CommandLauncherNode CommandLauncherNode.h "CommandLauncherNode.h"
 *  \brief This is a CommandLauncherNode class.  Used for the commandlauncher_node node.
 *
 */
class CommandLauncherNode: public BaseNode {
public:
	...
	CommandLauncherNodeProcess* get_process() { return process; }
	void thread_loop();
