...
/*! \brief Constructor
 */
TimeMasterNodeProcess::TimeMasterNodeProcess(std::string _base_node_name,std::string _node_name)
{
...
/*! \brief Run Unit Test
 */
std::vector<icarus_rover_v2::diagnostic> TimeMasterNodeProcess::run_unittest()
{
	std::vector<icarus_rover_v2::diagnostic> diaglist;
